export default function Hero() {
  return (
    <section id='home' className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[url('/background.png')] bg-cover bg-center bg-no-repeat">
      {/* Animated Background */}
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="text-center mt-12 md:mt-30">
          ...
          <p className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            ...
            <br />
            <span className="text-cyan-400 font-semibold">Data Science • AI Innovation • Hackathon</span>
          </p>
          ...
          <div className="mt-20">
            ...
            <div className="flex items-center justify-center p-4">
              ...
              {/* OLA */}
              <div className="flex items-center justify-center p-4">
                  <span className="text-white text-xl font-bold">DATA-AI</span>
              </div>
            </div>
          </div>
