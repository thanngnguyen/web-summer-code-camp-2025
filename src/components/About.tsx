      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Về <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Summer Code Camp</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Summer Code Camp là hành trình khám phá Data & AI, kết hợp chương trình đào tạo chuyên sâu về AI, Big Data và sân chơi Hackathon để các developer thử sức với những bài toán công nghệ thực tiễn.
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h3 className="text-3xl font-bold text-white mb-6">Tại sao tham gia Summer Code Camp?</h3>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-white mb-2">Thử thách vũ trụ</h4>
                  <p className="text-gray-300">Giải quyết các bài toán công nghệ từ thực tế với Data&AI</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-white mb-2">Kết nối thiên hà</h4>
                  <p className="text-gray-300">Gặp gỡ các senior, diễn giả và chuyên gia từ khắp vũ trụ</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-white mb-2">Kho báu vô tận</h4>
                  <p className="text-gray-300">Cơ hội nhận giải thưởng từ cuộc thi hackathon</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="w-full h-80 rounded-2xl overflow-hidden backdrop-blur-sm border border-white/10">
              ...
              <div 
                ...
                style={{
                  backgroundImage: "url('https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80')"
                }}
              >
              ...
              <div 
                ...
                style={{
                  backgroundImage: "url('https://images.unsplash.com/photo-1541873676-a18131494184?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80')"
                }}
              ></div>
              <div 
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div 
                  className="w-20 h-20 bg-cover bg-center rounded-full opacity-80 shadow-xl border-2 border-white/30 animate-pulse"
                  style={{
                    backgroundImage: "url('https://images.unsplash.com/photo-1446776877081-d282a0f896e2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80')"
                  }}
                ></div>
              </div>
            </div>
