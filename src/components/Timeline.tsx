...
export default function Timeline() {
  const timelineEvents = [
    {
      ...
      image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=100&q=80",
      color: "blue"
    },
    {
      date: "15/07/2025 - 11/08/2025", 
      title: "Workshop Series",
      description: "Tổ chức các Workshop về Python cơ bản, SQL, Xử lý dữ liệu, AI, Data,...",
    ...
    },
    {
      date: "16/08/2025",
      title: "Talkshow",
      description: "Tổ chức Talkshow gặp gỡ các senior, diễn giả và chuyên gia trong ngành",
      image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=100&q=80",
      color: "green"
    },
    {
      date: "25/08/2025 - 30/08/2025",
      title: "Hackathon chính",
      description: "Coding và phát triển sản phẩm đề tài cho trước trong 5 ngày",
      image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=100&q=80",
      color: "yellow"
    },
    {
      date: "19/10/2025",
      title: "Chung kết và trao giải",
      description: "Tổ chức buổi chung kết và trao giải cho các đội xuất sắc nhất",
  ...
  return (
    <section id="timeline" className="py-20 bg-slate-900/90 backdrop-blur-sm relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 right-1/3 w-1 h-1 bg-cyan-400 rounded-full animate-twinkle opacity-80" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-2/3 w-1.5 h-1.5 bg-purple-400 rounded-full animate-twinkle opacity-60" style={{animationDelay: '2s'}}></div>
      </div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
            Hành trình <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400">khám phá</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Theo dõi toàn bộ lịch trình của Summer Code Camp 2025 từ đăng ký đến Hackathon
          </p>
        </div>
              ...
              <div key={index} className={`relative flex items-center mb-16 ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                ...
                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                  <div className="bg-slate-800/80 backdrop-blur-md rounded-2xl p-8 shadow-2xl hover:shadow-3xl hover:shadow-purple-500/20 transition-all duration-500 border border-white/10 hover:border-purple-400/30 group">
                    {/* Image Icon */}
                    <div className={`inline-flex items-center justify-center w-16 h-16 rounded-xl mb-6 backdrop-blur-sm border-2 overflow-hidden ${getColorClasses(event.color)} group-hover:scale-110 transition-transform duration-300`}>
                      <div 
                        className="w-full h-full bg-cover bg-center"
                        style={{backgroundImage: `url(${event.image})`}}
                      >
                        <div className="w-full h-full bg-slate-900/40 backdrop-blur-sm flex items-center justify-center">
                        </div>
                      </div>
                    </div>
                    
                    <div className="text-sm text-cyan-400 font-bold mb-3 tracking-wider">{event.date}</div>
                    <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-cyan-300 transition-colors">{event.title}</h3>
        ...
        <div className="text-center mt-20">
          <div className="bg-gradient-to-br from-slate-800/90 via-purple-900/80 to-slate-800/90 backdrop-blur-md rounded-3xl p-10 text-white border border-purple-400/30 shadow-2xl">
            ...
            <p className="text-xl mb-8 text-gray-300 leading-relaxed max-w-2xl mx-auto">
              Đăng ký ngay để không bỏ lỡ cơ hội tham gia Summer Code Camp 2025 và trở thành nhà khám phá công nghệ
            </p>
            <button className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:shadow-2xl hover:shadow-purple-500/30 transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
